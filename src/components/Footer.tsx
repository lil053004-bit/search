...
export default function Footer() {
  ...
  return (
    <footer className="relative z-10 border-t-2 border-gray-200 mt-12 bg-white">
      <div className="max-w-[1400px] mx-auto px-6 sm:px-8 lg:px-12 py-8">
        {/* Legal Disclosure Section - Desktop */}
        <div className="hidden md:block bg-gray-50 border-2 border-red-200 rounded-lg p-6 mb-8 shadow-lg">
            ...
            <div className="flex-1">
              ...
              <div className="space-y-3 text-sm leading-relaxed text-gray-700">
                <div className="bg-white rounded p-3 border-l-4 border-blue-600">
                  <p className="font-bold text-gray-900 mb-2">【サービスの性質】</p>
                  <p>
                    本サービスは、AI技術を活用した株式情報の提供および分析ツールです。
                    <strong className="text-red-600">投資助言業務、投資一任業務、金融商品仲介業務には該当せず、特定の金融商品の売買を推奨・勧誘するものではありません。</strong>
                  </p>
                </div>

                <div className="bg-white rounded p-3 border-l-4 border-orange-500">
                  <p className="font-bold text-gray-900 mb-2">【投資リスクに関する警告】</p>
                  <p>
                    株式投資には価格変動リスク、信用リスク、流動性リスク等が伴い、
                    <strong className="text-red-600">投資元本を割り込む可能性があります。</strong>
                ...
                <div className="bg-white rounded p-3 border-l-4 border-blue-500">
                  <p className="font-bold text-gray-900 mb-2">【情報の正確性について】</p>
                  <p>
                ...
                <div className="bg-white rounded p-3 border-l-4 border-gray-400">
                  <p className="font-bold text-gray-900 mb-2">【投資判断の責任】</p>
                  <p>
                    <strong className="text-red-600">最終的な投資判断は、利用者ご自身の責任において行ってください。</strong>
                ...
                <div className="bg-gray-50 rounded p-3 mt-4">
                  <p className="font-bold text-gray-900 mb-1">【登録情報】</p>
        ...
        <div className="md:hidden bg-red-50 border-2 border-red-300 rounded-lg p-4 text-center mb-6">
          <p className="text-sm text-red-600 font-semibold mb-1">⚠️ 重要なお知らせ</p>
        ...
        <div className="border-t-2 border-gray-200 pt-6">
            ...
            <div>
              ...
              <ul className="space-y-2 text-xs sm:text-sm">
                <li>
                  <Link
                    to="/company"
                    className="text-gray-700 hover:text-red-600 hover:underline flex items-center gap-1"
                  >
          ...
          <div className="border-t border-gray-200 pt-4 text-center">
            <p className="text-xs sm:text-sm text-gray-900 mb-2 font-medium">
              &copy; {currentYear} 株式会社アドバンス (Advance Co., Ltd.). All rights reserved.
            </p>
            <p className="text-[10px] sm:text-xs text-gray-600 leading-relaxed max-w-3xl mx-auto mb-4">
