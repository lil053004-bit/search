export default function SoftBackground() {
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden bg-dark-gradient">
      <div className="absolute top-20 left-10 w-96 h-96 bg-gradient-to-br from-accent-yellow/10 to-accent-yellow/5 rounded-full blur-3xl"></div>
      ...
      <div className="absolute bottom-20 left-1/3 w-72 h-72 bg-gradient-to-br from-accent-yellow/8 to-accent-yellow/3 rounded-full blur-3xl"></div>
      ...
      <div className="absolute inset-0" style={{
        backgroundImage: `radial-gradient(circle at 2px 2px, rgba(252, 211, 77, 0.03) 1px, transparent 1px)`,
