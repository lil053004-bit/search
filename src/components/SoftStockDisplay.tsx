    ...
    <div className="w-full max-w-2xl mx-auto px-4 mb-6">
      ...
      >
        <div className="flex items-start justify-between mb-6">
          <div>
            <h2 className="text-2xl font-bold text-gray-800 mb-1">{info.name}</h2>
          ...
          <div className={`px-4 py-2 rounded-full ${isPositive ? 'bg-gradient-to-r from-emerald-50 to-teal-50' : 'bg-gradient-to-r from-rose-50 to-pink-50'}`}>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
          <div className="bg-gradient-to-br from-gray-50 to-gray-100/50 rounded-2xl p-4">
            ...
            <p className="text-xl font-bold text-gray-800">¥{price.current.toLocaleString()}</p>
          </div>
          <div className="bg-gradient-to-br from-gray-50 to-gray-100/50 rounded-2xl p-4">
